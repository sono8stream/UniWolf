...
namespace WodiLib.Database
{
    ...
    public class DataName : IConvertibleString, IEquatable<DataName>
    {
        ...
        /// <summary>
        /// string -> DataName への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator DataName(string src)
        {
            if (src is null) return null;
            var result = new DataName(src);
            return result;
        }

        /// <summary>
        /// DataName -> string への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator string(DataName src)
        {
            return src?.Value;
        }
        ...
        public static bool operator ==(DataName left, DataName right)
        {
