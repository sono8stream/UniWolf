...
{
    /// <summary>
    /// [NotNull][NotNewLine] DB項目名
    /// </summary>
    [Serializable]
    public class ItemName : IConvertibleString, IEquatable<ItemName>
    {
        // _/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
        //     Public Property
        // _/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/

        /// <summary>DB項目名</summary>
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="value">[NotNull][NotNewLine] DB項目名</param>
        ...
        /// <summary>
        /// string -> ItemName への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator ItemName(string src)
        {
            if (src is null) return null;
            var result = new ItemName(src);
            return result;
        }

        /// <summary>
        /// ItemName -> string への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator string(ItemName src)
        {
            return src?.Value;
        }
