...
namespace WodiLib.Database
{
    ...
    /// </summary>
    [Serializable]
    public class DatabaseMemo : IConvertibleString, IEquatable<DatabaseMemo>
    {
        // _/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
        //     Public Property
        // _/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/

        /// <summary>データベースメモ</summary>
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="value">[NotNull] データベースメモ</param>
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((DatabaseMemo) obj);
        }
        ...
        /// <summary>
        /// DatabaseMemo -> string への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator string(DatabaseMemo src)
        {
            return src?.Value;
        }
        ...
        public static bool operator ==(DatabaseMemo left, DatabaseMemo right)
        {
