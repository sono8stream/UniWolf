...
namespace WodiLib.Cmn
{
    ...
    public class SystemVariableAddress : VariableAddress, IEquatable<SystemVariableAddress>
    {
        ...
        /// <summary>最小値</summary>
        public new static int MinValue => 9000000;

        /// <summary>最大値</summary>
        public new static int MaxValue => 9099999;
        ...
        public static implicit operator SystemVariableAddress(int src)
        {
        ...
        ///     src が null の場合
        /// </exception>
        public static implicit operator int(SystemVariableAddress src)
        {
            if (src is null)
                throw new InvalidCastException(
                    ErrorMessage.InvalidCastFromNull(nameof(src), nameof(SystemVariableAddress)));
        ...
        public static int operator -(SystemVariableAddress left, VariableAddress right)
        {
            if (left is null)
                throw new InvalidOperationException(
                    ErrorMessage.NotNull("左オペランド"));
        ...
        public static bool operator ==(SystemVariableAddress left, VariableAddress right)
        {
