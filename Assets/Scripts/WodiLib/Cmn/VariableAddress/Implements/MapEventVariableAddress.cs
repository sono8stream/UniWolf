...
namespace WodiLib.Cmn
{
    ...
    /// </summary>
    [Serializable]
    public class MapEventVariableAddress : VariableAddress, IEquatable<MapEventVariableAddress>
    {
        ...
        /// <summary>最小値</summary>
        public new static int MinValue => 1000000;

        /// <summary>最大値</summary>
        public new static int MaxValue => 1099999;
        ...
        public bool Equals(MapEventVariableAddress other)
        {
        ...
        /// <summary>
        /// int -> MapEventVariableAddress への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator MapEventVariableAddress(int src)
        {
        ...
        /// <summary>
        /// MapEventVariableAddress -> int への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        ...
        ///     src が null の場合
        /// </exception>
        public static implicit operator int(MapEventVariableAddress src)
        {
            if (src is null)
                throw new InvalidCastException(
                    ErrorMessage.InvalidCastFromNull(nameof(src), nameof(MapEventVariableAddress)));
        ...
        ///     left が null の場合、または
        ///     加算後の値がマップイベントセルフ変数アドレス値として不適切な場合
        /// </exception>
        ...
        /// <exception cref="InvalidOperationException">
        ///     left が null の場合、または
        ///     減算後の値がマップイベントセルフ変数アドレス値値として不適切な場合
        /// </exception>
        public static MapEventVariableAddress operator -(MapEventVariableAddress src, int value)
        {
            if (src is null)
        ...
        /// </exception>
        public static int operator -(MapEventVariableAddress left, VariableAddress right)
        {
            if (left is null)
                throw new InvalidOperationException(
                    ErrorMessage.NotNull("左オペランド"));
        ...
        public static bool operator ==(MapEventVariableAddress left, VariableAddress right)
        {
        ...
        /// <param name="right">右辺</param>
        /// <returns>左辺==右辺の場合true</returns>
        public static bool operator ==(MapEventVariableAddress left, MapEventVariableAddress right)
        {
            if (ReferenceEquals(left, right)) return true;
