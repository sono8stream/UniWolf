...
namespace WodiLib.Cmn
{
    ...
    public readonly struct RandomVariableValue : IConvertibleInt, IEquatable<RandomVariableValue>
    {
        ...
        {
            return obj is RandomVariableValue other && Equals(other);
        }
        ...
        public bool Equals(RandomVariableValue other)
        {
        ...
        /// <summary>
        /// int -> RandomVariableValue への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator RandomVariableValue(int src)
        {
        ...
        /// <summary>
        /// RandomVariableValue -> int への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator int(RandomVariableValue src)
        {
            return src.Value;
        }
