...
namespace WodiLib.Cmn
{
    ...
    public readonly struct SpareNumberVariableNumber : IConvertibleInt, IEquatable<SpareNumberVariableNumber>
    {
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="value">[Range(0, 9)] 予備変数番号</param>
        /// <exception cref="ArgumentOutOfRangeException">valueが予備変数番号として不適切な場合</exception>
        public SpareNumberVariableNumber(int value)
        {
        ...
        /// <summary>
        /// int -> SpareNumberVariableNumber への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator SpareNumberVariableNumber(int src)
        {
            var result = new SpareNumberVariableNumber(src);
            return result;
        }

        /// <summary>
        /// SpareNumberVariableNumber -> int への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator int(SpareNumberVariableNumber src)
        {
            return src.Value;
        }
