...
namespace WodiLib.Sys.Cmn
{
    ...
    public class WodiLibLogHandler
    {
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="errorAction">[Nullable] エラーメッセージ処理</param>
        /// <param name="warningAction">[Nullable] 警告メッセージ処理</param>
        /// <param name="infoAction">[Nullable] 情報メッセージ処理</param>
        /// <param name="debugAction">[Nullable] デバッグメッセージ処理</param>
