...
namespace WodiLib.Event.CharaMoveCommand
{
    ...
    public class AddValue : CharaMoveCommandBase, ISerializable
    {
        ...
        ///     対象アドレス
        /// </summary>
        /// <exception cref="PropertyNullException">nullをセットしたとき</exception>
        ...
        {
            var targetStr = resolver.GetNumericVariableAddressString(
        ...
        /// <param name="context">コンテキスト</param>
        [EditorBrowsable(EditorBrowsableState.Never)]
        protected AddValue(SerializationInfo info, StreamingContext context)
        {
