...
// File Name    : ExecutionTransition.cs
//
...
namespace WodiLib.Event.EventCommand
{
    ...
    public class ExecutionTransition : EventCommandBase
    {
        ...
        private const string EventCommandSentenceFormat = "■トランジション実行";
        ...
        /// <inheritdoc />
        public override EventCommandCode EventCommandCode => EventCommandCode.ExecutionTransition;
