...
namespace WodiLib.Event.EventCommand
{
    ...
    /// </summary>
    [Serializable]
    public class WaitEventCommand : EventCommandBase
    {
        ...
        /// <inheritdoc />
        public override EventCommandCode EventCommandCode => EventCommandCode.Wait;
        ...
        {
            var waitStr = resolver.GetNumericVariableAddressStringIfVariableAddress(WaitTime, type, desc);
            return string.Format(EventCommandSentenceFormat, waitStr);
        }
