...
// File Name    : DBManagementGetItemLength.cs
//
...
namespace WodiLib.Event.EventCommand
{
    ...
    /// </summary>
    [Serializable]
    public class DBManagementGetItemLength : DBManagementOutputBase
    {
        ...
        {
            get => EventCommandConstant.DBManagement.IdSet.GetItemLength.ItemId;
            set { }
        }
