...
// File Name    : ChoiceStartForkingSpecialBase.cs
//
...
namespace WodiLib.Event.EventCommand
{
    /// <inheritdoc />
    /// <summary>
    /// イベントコマンド・選択肢・分岐開始（特殊分岐）共通ベースクラス
    /// </summary>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public abstract class ChoiceStartForkingSpecialBase : EventCommandBase
    {
