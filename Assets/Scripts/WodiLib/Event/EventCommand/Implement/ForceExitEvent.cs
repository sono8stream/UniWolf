...
namespace WodiLib.Event.EventCommand
{
    ...
    public class ForceExitEvent : EventCommandBase
    {
        ...
        private const string EventCommandSentenceFormat = "■イベント処理中断";
        ...
        /// <inheritdoc />
        public override EventCommandCode EventCommandCode => EventCommandCode.ForceExitEvent;
        ...
        /// 数値変数を設定する。
        /// </summary>
        /// <param name="index">[Range(1, )] インデックス</param>
