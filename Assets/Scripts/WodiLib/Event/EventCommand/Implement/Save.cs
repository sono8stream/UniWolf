...
namespace WodiLib.Event.EventCommand
{
    ...
    /// </summary>
    [Serializable]
    public class Save : EventCommandBase
    {
        // _/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/
        //     Private Constant
        // _/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/

        private const string EventCommandSentenceFormat = "■データのセーブ： {0}";
        ...
        /// <inheritdoc />
        public override EventCommandCode EventCommandCode => EventCommandCode.Save;
        ...
        public override int GetSafetyNumberVariable(int index)
        {
            switch (index)
            {
                ...
                case 1:
                    return EventCommandConstant.SaveLoad.ExecCode.Save;
