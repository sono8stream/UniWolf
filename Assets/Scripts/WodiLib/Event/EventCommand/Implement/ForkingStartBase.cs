...
namespace WodiLib.Event.EventCommand
{
    ...
    public abstract class ForkingStartBase : EventCommandBase
    {
        ...
        protected byte ChoiceCodeRaw { get; set; }
    }
}