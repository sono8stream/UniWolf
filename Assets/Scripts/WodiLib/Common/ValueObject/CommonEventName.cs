...
namespace WodiLib.Common
{
    ...
    /// </summary>
    [Serializable]
    public class CommonEventName : IConvertibleString, IEquatable<CommonEventName>
    {
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="value">[NotNull] コモンイベント名</param>
        ...
        public CommonEventName(string value)
        {
            if (value is null)
        ...
        {
            return obj is CommonEventName other && Equals(other);
        }
        ...
        /// <summary>
        /// string -> CommonEventName への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator CommonEventName(string src)
        {
            if (src is null) return null;
            var result = new CommonEventName(src);
            return result;
        }

        /// <summary>
        /// CommonEventName -> string への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator string(CommonEventName src)
        {
            return src?.Value;
        }
