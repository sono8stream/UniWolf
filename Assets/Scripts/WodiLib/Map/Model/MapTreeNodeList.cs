...
namespace WodiLib.Map
{
    ...
    public class MapTreeNodeList : RestrictedCapacityCollection<MapTreeNode>
    {
        ...
        public static readonly int MaxCapacity = 9999;
        ...
        public MapTreeNodeList(IReadOnlyCollection<MapTreeNode> list) : base(list)
        {
        }
        ...
        /// <inheritdoc />
        protected override MapTreeNode MakeDefaultItem(int index)
            => new MapTreeNode();
