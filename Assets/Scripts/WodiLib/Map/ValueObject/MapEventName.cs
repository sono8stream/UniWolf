...
namespace WodiLib.Map
{
    ...
    public class MapEventName : IConvertibleString, IEquatable<MapEventName>
    {
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="value">[NotNull][NotNewLine] マップイベント名</param>
        ...
        public MapEventName(string value)
        {
            if (value is null)
        ...
        public bool Equals(MapEventName other)
        {
        ...
        public static bool operator ==(MapEventName left, MapEventName right)
        {
