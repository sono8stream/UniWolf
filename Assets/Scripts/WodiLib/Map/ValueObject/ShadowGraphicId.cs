...
namespace WodiLib.Map
{
    ...
    public readonly struct ShadowGraphicId : IConvertibleByte, IEquatable<ShadowGraphicId>
    {
        ...
        /// <summary>最大値</summary>
        public static readonly int MaxValue = 255;
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="value">[Range(0, 255)] 影グラフィックID</param>
        /// <exception cref="ArgumentOutOfRangeException">numberが影グラフィックIDとして不適切な場合</exception>
        public ShadowGraphicId(byte value)
        {
        ...
        {
            return obj is ShadowGraphicId other && Equals(other);
        }
        ...
        public bool Equals(ShadowGraphicId other)
        {
        ...
        public static bool operator ==(ShadowGraphicId left, ShadowGraphicId right)
        {
