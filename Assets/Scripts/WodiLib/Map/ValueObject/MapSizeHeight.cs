...
namespace WodiLib.Map
{
    ...
    public readonly struct MapSizeHeight : IConvertibleInt, IEquatable<MapSizeHeight>
    {
        ...
        /// <summary>最小値</summary>
        public static readonly int MinValue = 15;
        ...
        /// コンストラクタ
        /// </summary>
        /// <param name="value">[Range(15, 9999)] マップサイズ縦</param>
        /// <exception cref="ArgumentOutOfRangeException">numberが指定範囲外の場合</exception>
        public MapSizeHeight(int value)
        {
        ...
        {
            return obj is MapSizeHeight other && Equals(other);
        }
        ...
        public bool Equals(MapSizeHeight other)
        {
        ...
        public static bool operator ==(MapSizeHeight left, MapSizeHeight right)
        {
