...
namespace WodiLib.IO
{
    ...
    public class CommonEventDatFilePath : FilePath, IEquatable<CommonEventDatFilePath>
    {
        ...
        public static readonly Regex FilePathRegex = new Regex(@"^CommonEvent\.dat$", RegexOptions.IgnoreCase);
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((CommonEventDatFilePath) obj);
        }
        ...
        /// <summary>
        /// string -> CommonEventDatFilePath への暗黙的な型変換
        /// </summary>
        ...
        /// <summary>
        /// CommonEventDatFilePath -> string への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator string(CommonEventDatFilePath src)
        {
            return src?.Value;
        }
        ...
        public static bool operator ==(CommonEventDatFilePath left, CommonEventDatFilePath right)
        {
