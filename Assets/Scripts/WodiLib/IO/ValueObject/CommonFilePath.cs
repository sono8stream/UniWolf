...
namespace WodiLib.IO
{
    ...
    public class CommonFilePath : FilePath, IEquatable<CommonFilePath>
    {
        ...
        public static readonly Regex FilePathRegex = new Regex(@"^(.*)\.common$", RegexOptions.IgnoreCase);
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals((CommonFilePath) obj);
        }
        ...
        public bool Equals(CommonFilePath other)
        {
        ...
        /// <summary>
        /// string -> CommonFilePath への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator CommonFilePath(string src)
        {
            if (src is null) return null;
            var result = new CommonFilePath(src);
            return result;
        }

        /// <summary>
        /// CommonFilePath -> string への暗黙的な型変換
        /// </summary>
        /// <param name="src">変換元</param>
        /// <returns>変換したインスタンス</returns>
        public static implicit operator string(CommonFilePath src)
        {
            return src?.Value;
        }
        ...
        public static bool operator ==(CommonFilePath left, CommonFilePath right)
        {
